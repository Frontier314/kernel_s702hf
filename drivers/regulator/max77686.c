...
#define PMIC_DEBUG KERN_DEBUG //KERN_INFO
...
static struct regulator_ops max77686_ldo_ops = {
	...
	.set_suspend_disable	=max77686_reg_disable, 	//jeff, max77686_reg_do_nothing ?
};
...
static __devinit int max77686_pmic_probe(struct platform_device *pdev)
{
	...
	/* liuyx add, enable P32KH LowJitterMode for FM*/
	max77686_update_reg(i2c, MAX77686_REG_32KHZ, 0x1 << 3, 0x1 << 3);
