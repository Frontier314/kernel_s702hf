...
#define	MCDRV_EVT_ADCMUTE					(0x00050000UL)
#define	MCDRV_EVT_ADC1MUTE					(0x00060000UL)
#define	MCDRV_EVT_PDMMUTE					(0x00070000UL)
#define	MCDRV_EVT_SVOL_DONE					(0x00080000UL)
#define	MCDRV_EVT_APM_DONE					(0x00090000UL)
#define	MCDRV_EVT_ANA_RDY					(0x000A0000UL)
#define	MCDRV_EVT_SYSEQ_FLAG_RESET			(0x000B0000UL)
#define	MCDRV_EVT_CLKBUSY_RESET				(0x000C0000UL)
#define	MCDRV_EVT_CLKSRC_SET				(0x000D0000UL)
#define	MCDRV_EVT_CLKSRC_RESET				(0x000E0000UL)
#define	MCDRV_EVT_CDSPBFLAG_SET				(0x000F0000UL)
#define	MCDRV_EVT_CDSPBFLAG_RESET			(0x00100000UL)
#define	MCDRV_EVT_CDFLAG_SET				(0x00200000UL)
#define	MCDRV_EVT_CDFLAG_RESET				(0x00400000UL)
...
void		McDevIf_ReadDirect			(UINT32 dDesc, UINT8* pbData);
