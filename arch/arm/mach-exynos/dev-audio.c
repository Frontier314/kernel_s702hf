...
//				{ EXYNOS4_GPZ(0),  7, S3C_GPIO_SFN(2) },
				{ EXYNOS4_GPZ(0),  1, S3C_GPIO_SFN(2) },
//				{ EXYNOS4_GPZ(2),  5, S3C_GPIO_SFN(2) },
	...
	s3c_gpio_cfgpin(EXYNOS4_GPZ(2),S3C_GPIO_SFN(2));
	s3c_gpio_cfgpin(EXYNOS4_GPZ(3),S3C_GPIO_SFN(2));
	s3c_gpio_cfgpin(EXYNOS4_GPZ(4),S3C_GPIO_SFN(2));
	return 0;
}
...
static int exynos_pcm_cfg_gpio(struct platform_device *pdev)
{
	...
	struct exynos_gpio_cfg exynos4_cfg[4] = {
                                { EXYNOS4_GPZ(0),  1, S3C_GPIO_SFN(2) },
                                { EXYNOS4_GPZ(2),  5, S3C_GPIO_SFN(2) },
